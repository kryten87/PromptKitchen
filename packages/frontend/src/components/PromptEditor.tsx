...
export function PromptEditor({ prompt, onPromptUpdated, onViewHistory }: PromptEditorProps) {
  ...
  return (
    <div className="p-6 bg-white rounded-lg border border-gray-200 shadow-sm">
      <div className="mb-4">
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Edit Prompt</h3>
